...
class Vector3f {
	...
	/**
	 * Performs addition of this <code>Vector3f</code> with
	 * another.<br/>
	 *
	 * It is equivalent to : <br/>
	 * &nbsp;&nbsp;&nbsp;&nbsp;
	 * <code>this = this + summand</code>.
	 *
	 * @param summand the <code>Vector3f</code> to be added.
	 */
	 ...
	 * &nbsp;&nbsp;&nbsp;&nbsp;
	 * <code>
     *     this = [(this.x + summand), (this.y + summand),
     *               (this.z+summand)]
	 * </code>.
	 *
	 * @param summand the <code>Vector3f</code> to be added.
